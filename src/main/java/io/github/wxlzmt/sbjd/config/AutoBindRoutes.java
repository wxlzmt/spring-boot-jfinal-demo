...
/**
 * 本类代码借鉴自 https://github.com/jflyfox/jfinal_cms/tree/master/src/main/java/com/jflyfox/jfinal/component/annotation/AutoBindRoutes.java
 * 
 * 自动绑定（来自jfinal ext)
...
public class AutoBindRoutes extends Routes {
	...
	public void config() {
		List<Class<? extends Controller>> controllerClasses = ClassSearcher.findInClasspath(Controller.class);
